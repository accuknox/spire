...
import (
	...
	"github.com/accuknox/spire/pkg/agent/common/backoff"
...
func (m *manager) storeBundle(bundle *bundleutil.Bundle) {
	...
	if err := m.storage.StoreBundle(rootCAs); err != nil {
		...
		m.c.Log.Debugf("Bundle updated in data store")
	}
}
