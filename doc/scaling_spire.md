...
For additional detail on how this is achieved, refer to the following SPIFFE spec that describes the mechanism: <https://github.com/accuknox/spiffe/blob/main/standards/SPIFFE_Federation.md#4-spiffe-bundle-endpoint>

For a tutorial on configuring Federated SPIRE, refer to: <https://github.com/accuknox/spire-tutorials/tree/main/docker-compose/federation>
