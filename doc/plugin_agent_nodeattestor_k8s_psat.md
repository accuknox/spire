...
A full example of this attestor is provided in [the SPIRE examples repository](https://github.com/accuknox/spire-examples/tree/main/examples/k8s/simple_psat).
