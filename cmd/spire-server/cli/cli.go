...
import (
	...
	"github.com/accuknox/spire/cmd/spire-server/cli/agent"
	"github.com/accuknox/spire/cmd/spire-server/cli/bundle"
	"github.com/accuknox/spire/cmd/spire-server/cli/entry"
	"github.com/accuknox/spire/cmd/spire-server/cli/federation"
	"github.com/accuknox/spire/cmd/spire-server/cli/healthcheck"
	"github.com/accuknox/spire/cmd/spire-server/cli/jwt"
	localauthority_jwt "github.com/accuknox/spire/cmd/spire-server/cli/localauthority/jwt"
	localauthority_x509 "github.com/accuknox/spire/cmd/spire-server/cli/localauthority/x509"
	"github.com/accuknox/spire/cmd/spire-server/cli/logger"
	"github.com/accuknox/spire/cmd/spire-server/cli/run"
	"github.com/accuknox/spire/cmd/spire-server/cli/token"
	"github.com/accuknox/spire/cmd/spire-server/cli/upstreamauthority"
	"github.com/accuknox/spire/cmd/spire-server/cli/validate"
	"github.com/accuknox/spire/cmd/spire-server/cli/wit"
	"github.com/accuknox/spire/cmd/spire-server/cli/x509"
